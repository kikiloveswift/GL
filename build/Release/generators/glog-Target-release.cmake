...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET glog::glog
                 ...
                 $<$<CONFIG:Release>:${glog_LINKER_FLAGS_RELEASE}>)
    set_property(TARGET glog::glog
                 APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${glog_INCLUDE_DIRS_RELEASE}>)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET glog::glog
                 APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${glog_LIB_DIRS_RELEASE}>)
    set_property(TARGET glog::glog
                 APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${glog_COMPILE_DEFINITIONS_RELEASE}>)
    set_property(TARGET glog::glog
                 APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${glog_COMPILE_OPTIONS_RELEASE}>)
