...
set(gflags_INCLUDE_DIRS ${gflags_INCLUDE_DIRS_RELEASE} )
set(gflags_INCLUDE_DIR ${gflags_INCLUDE_DIRS_RELEASE} )
set(gflags_LIBRARIES ${gflags_LIBRARIES_RELEASE} )
set(gflags_DEFINITIONS ${gflags_DEFINITIONS_RELEASE} )


# Only the last installed configuration BUILD_MODULES are included to avoid the collision
foreach(_BUILD_MODULE ${gflags_BUILD_MODULES_PATHS_RELEASE} )
